import { visitRepository, followUpRepository } from '@/repositories'
import { revalidatePath } from 'next/cache'

/**
 * Visit Service — orchestrates visit-related business logic.
 * Business Rules:
...
/**
 * Create a new clinical visit record.
 * Auto-creates a follow-up if nextVisitDate is set.
 */
